---
title: SharePoint Online과 PowerApps, 파워 자동화 및 Power BI 통합 (소개) | Microsoft Docs
description: 이 자습서 시리즈에서는 sharepoint 목록과 SharePoint Online과 통합 되는 세 가지 주요 기술 (PowerApps, 파워 자동화 및 Power BI)을 기반으로 하는 프로젝트 관리를 위한 기본 캔버스 앱을 빌드하는 방법에 대해 살펴봅니다.
author: NickWaggoner
manager: kvivek
...
ms.locfileid: "73898275"
---
# <a name="integrate-powerapps-power-automate-and-power-bi-with-sharepoint-online"></a>SharePoint Online과 PowerApps, 파워 자동화 및 Power BI 통합
SharePoint Online을 가지고 있고 비즈니스 프로세스를 더 효율적으로 자동화하고 간소화하고 싶습니까? PowerApps, 파워 자동화 또는 Power BI으로 작업 했지만 SharePoint Online에서 사용 하는 방법을 잘 모를 수 있나요? 그렇다면 제대로 찾아오셨습니다! 이 자습서 시리즈에서는 sharepoint 목록과 SharePoint Online과 통합 되는 세 가지 주요 기술 (PowerApps, 파워 자동화 및 Power BI)을 기반으로 하는 프로젝트 관리를 위한 기본 캔버스 앱을 빌드하는 방법에 대해 살펴봅니다. 이러한 기술을 함께 사용하면 비즈니스를 *측정*하고 결과에서 *작동*하고 워크플로를 *자동화*할 수 있습니다. 이 시리즈를 마치면 다음과 같이 멋진 시나리오를 갖게 됩니다.
...
이 시리즈의 자습서에서 소개하는 시나리오는 완전한 프로젝트 관리 및 분석 앱에 비해 간단하지만, 모든 작업을 완료하는 데 약간의 시간이 걸립니다. PowerApps를 사용 하는 방법에 대 한 간략 한 소개, Power 자동화 및 SharePoint와 Power BI에 대 한 간략 한 소개는 다음 문서를 참조 하세요.
...
이 시나리오를 완료하려면 다음 구독 및 데스크톱 도구가 필요합니다. Office 365 Business Premium subscription에는 PowerApps 및 전원 자동화가 포함 되어 있습니다.
