...
|관계 유형|설명|  
|-----------------------|-----------------|  
|**1:N(일대다)**|관련 엔터티의 조회 필드 때문에 **기본 엔터티**의 엔터티 레코드 하나를 다른 많은 **관련 엔터티** 레코드에 연결할 수 있는 엔터티 관계입니다.<br /><br /> 기본 엔터티 레코드를 볼 때 해당 레코드에 연결된 관련 엔터티 레코드 목록을 볼 수 있습니다.<br /><br /> PowerApps 포털에서 **현재 엔터티**는 기본 엔터티를 나타냅니다.|  
