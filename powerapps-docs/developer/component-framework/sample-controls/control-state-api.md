---
title: 컨트롤 상태 API | Microsoft Docs
description: ''
keywords: PowerApps PowerApps 구성 요소 프레임 워크
ms.author: nabuthuk
author: Nkrb
manager: kvivek
ms.date: 10/01/2019
...
ms.locfileid: "72340532"
---
# <a name="implementing-control-state-api-component"></a>컨트롤 상태 API 구성 요소 구현

PowerApps 구성 요소 프레임 워크를 사용 하면 동일한 세션 내에서 구성 요소의 여러 렌더링에 걸쳐 구성 요소의 상태를 유지할 수 있습니다. 사용자가 구성 요소에서 탐색 하는 동안 사용자 세션 전체에서 사용자 상태를 유지할 수 있는 구성 요소를 빌드하는 기능을 제공 합니다.

예를 들어 코드 구성 요소가 사용자가 스크롤할 수 있는 긴 목록이 면 **_Setcontrolstate_** 기능을 활용 하 여 사용자가 폼에서 이동할 때 표시 되는 목록에서 해당 지점을 기억할 수 있습니다. 그런 다음 구성 요소 초기화에 논리를 추가 하 여 저장 된 상태를 확인 하 고 사용자가 이전에 읽은 지점에서 구성 요소의 목록을 렌더링할 수 있습니다.

> [!div class="mx-imgBorder"] 
> ![컨트롤 상태 api](../media/control-state-api.png "컨트롤 상태 api")
