...
5. 연필 편집 아이콘을 ![클릭하거나 누른](./media/sharepoint-scenario-summary/icon-check-mark.png)다음 브라우저 탭을 닫습니다.
...
5. 연필 편집 아이콘을 ![클릭하거나 누른](./media/sharepoint-scenario-summary/icon-check-mark.png) 변경 내용을 SharePoint 목록에 적용합니다.
