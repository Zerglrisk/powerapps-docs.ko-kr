...
* **PowerApps**: [Power Apps를 사용 하 여 sharepoint 내에서 앱 생성](app-from-sharepoint.md#generate-an-app-from-within-sharepoint-online) 및 [sharepoint 목록의 데이터를 관리 하는 앱 생성](app-from-sharepoint.md)
