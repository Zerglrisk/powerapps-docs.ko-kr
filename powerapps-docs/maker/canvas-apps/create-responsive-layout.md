...
응용 프로그램의 레이아웃이 화면 차원의 변경 내용에 응답 하도록 하려면 화면의 **Width** 및 **Height** 속성을 사용 하는 수식을 작성 합니다. 이러한 속성을 표시 하려면 Power Apps 스튜디오에서 앱을 연 다음 화면을 선택 합니다. 이러한 속성에 대 한 기본 수식은 오른쪽 창의 **고급** 탭에 나타납니다.
