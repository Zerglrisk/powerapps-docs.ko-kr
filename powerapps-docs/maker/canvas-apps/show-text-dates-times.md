...
**[Text](controls/control-text-box.md)** 속성의 값을 설정하여 **[레이블](controls/properties-core.md)** 컨트롤에 텍스트를 표시합니다. 컨트롤에 직접 입력하거나 수식 입력줄에 식을 입력하여 이 속성을 설정합니다.
...
1. **ShowText[라는 ](controls/control-text-box.md)** 레이블 컨트롤을 추가하고, **[Text](controls/properties-core.md)** 속성을 다음 수식으로 설정합니다.
   <br>**Now()**
...
2. **ShowText[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
...
3. **BirthDate[라는 ](controls/control-text-input.md)** 텍스트 입력 컨트롤을 추가하고 **ShowText** 아래로 이동합니다.

4. **BirthDate**에서 생년월일의 월과 일을 입력합니다(예: **05/18**).

5. **ShowText[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
...
1. **ArrivalDateTime[이라는 ](controls/control-text-input.md)** 텍스트 입력 컨트롤을 추가하고 날짜와 시간을 다음 형식으로 입력합니다.
   <br>**5/10/85 6:15 AM**
2. **ShowDate[라는 ](controls/control-text-box.md)** 레이블 컨트롤을 추가하고, **[Text](controls/properties-core.md)** 속성을 다음 수식으로 설정합니다.
...
3. **ShowDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 변경합니다.
   ...
   > 
   > 
4. 여러 기본 제공 형식 중 하나를 사용하려면 **ShowDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 변경합니다.
   ...
   > 
   > 
5. 사용자 지정 형식을 사용하려면 **ShowDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 변경합니다.
...
1. **ArrivalDate[라는 ](controls/control-text-input.md)** 텍스트 입력 컨트롤을 추가한 다음 날짜를 입력합니다(예: **5/10/85**).

2. **FormatDate[라는 ](controls/control-text-box.md)** 레이블 컨트롤을 추가하고, **[Text](controls/properties-core.md)** 속성을 다음 수식으로 설정합니다.
   <br>**DateValue(ArrivalDate.Text)**
   
    **FormatDate**는 입력한 날짜를 표시합니다. 단, 연도는 4자리 숫자로 표시됩니다.
3. **FormatDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
   <br>**DateValue(ArrivalDate.Text, "fr")**
   
    **FormatDate**는 프랑스 사용자가 기대하는 것처럼 그 달 전날을 표시합니다.
4. 여러 기본 제공 형식 중 하나를 사용하려면 **FormatDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
   <br>**Text(DateValue(ArrivalDate.Text), DateTimeFormat.LongDate)**
   
    **FormatDate**는 요일, 월, 일 및 연도를 표시합니다.
5. 사용자 지정 형식을 사용하려면 **FormatDate[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
...
1. **ArrivalTime [이라는 이름의 ](controls/control-text-input.md)** 텍스트 입력 컨트롤을 추가한 다음 **6:15 AM**을 입력합니다.

2. **ShowTime[이라는 ](controls/control-text-box.md)** 레이블 컨트롤을 추가합니다.

3. 여러 기본 제공 형식 중 하나를 사용하려면 **ShowTime[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
   <br>**Text(DateTimeValue(ArrivalTime.Text), DateTimeFormat.LongTime)**
   
    **ShowTime**은 지정한 시간(초 포함)을 표시합니다.
4. 사용자 지정 형식을 사용하려면 **ShowTime[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
...
1. **Start[와 ](controls/control-text-input.md)End**라는 두 개의텍스트 입력 컨트롤을 추가합니다.

2. **Start**에서 **4/1/2015**를 입력하고, **End**에서 **1/1/2016**을 입력합니다.

3. **DateDiff[라는 ](controls/control-text-box.md)** 레이블 컨트롤을 추가하고, **[Text](controls/properties-core.md)** 속성을 다음 수식으로 설정합니다.
...
4. **DateDiff[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.  <br>**DateDiff(DateValue(Start.Text), DateValue(End.Text), Months)**
...
1. **Start[라는 ](controls/control-text-input.md)** 텍스트 입력 컨트롤을 추가하고 **5/10/1985**를 입력합니다.

2. **DateAdd[라는 이름의 ](controls/control-text-box.md)** 레이블 컨트롤을 추가하고, **[Text](controls/properties-core.md)** 속성을 다음 수식으로 설정합니다.
...
3. **DateAdd[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 설정합니다.
   <br>**DateAdd(DateValue(Start.Text), -3)**
   
    ![3일 빼기](./media/show-text-dates-times/date-subtract.png)
   
    **DateAdd**는 **Start**에 있는 날짜로부터 3일 전인 **5/7/1985**를 표시합니다.
4. **DateAdd[의 ](controls/properties-core.md)** Text 속성을 다음 수식으로 변경합니다.
...
1. **Year[, ](controls/control-drop-down.md)Month** 및 **Day**라는 3개의드롭다운 컨트롤을 추가합니다.

2. **Year[의 ](controls/properties-core.md)** Items 속성을 다음 수식으로 설정합니다.
   <br>**Table({Year:"2014"}, {Year:"2015"}, {Year:"2016"})**

3. **Month[의 ](controls/properties-core.md)** Items 속성을 다음 수식으로 설정합니다.
   <br>**Table({Month:"1"}, {Month:"2"}, {Month:"3"}, {Month:"4"}, {Month:"5"}, {Month:"6"}, {Month:"7"}, {Month:"8"}, {Month:"9"}, {Month:"10"}, {Month:"11"}, {Month:"12"})**

4. **Day[의 ](controls/properties-core.md)** Items 속성을 다음 수식으로 설정합니다.
...
예상하지 않은 데이터를 변환해야 할 수도 있습니다. **[드롭다운](controls/control-text-input.md)** 컨트롤 대신 **[텍스트 입력](controls/control-drop-down.md)** 컨트롤을 추가하면 사용자가 5월 45일과 같은 잘못된 날짜를 입력할 수 있습니다. **[Date](functions/function-date-time.md)** 함수는 다음과 같은 방법으로 비정형 데이터를 처리합니다.
...
2. **Hour[의 ](controls/properties-core.md)** Items 속성을 다음 수식으로 설정합니다:
   <br>**Table({Hour:"9"}, {Hour:"10"}, {Hour:"11"}, {Hour:"12"}, {Hour:"13"}, {Hour:"14"}, {Hour:"15"}, {Hour:"16"}, {Hour:"17"})**

3. **Minute[의 ](controls/properties-core.md)** Items 속성을 다음 수식으로 설정합니다:
...
5. **Hour**에서 **15**, **Minute**에서 **45**를 선택합니다.
    ...
    **[레이블](controls/control-text-box.md)** 컨트롤에서 **3:45 PM**을 표시합니다.
    ...
    사용자가 더 큰 시간 범위와 더 정밀한 분 수에서 선택할 수 있도록 **Hour** 및 **Minute**에 항목을 추가할 수 있습니다. 사용자가 초를 지정할 수 있도록 세 번째 **[드롭다운](controls/control-drop-down.md)** 컨트롤을 추가할 수도 있습니다. 세 번째 목록을 추가하는 경우 **[레이블](controls/properties-core.md)** 컨트롤의 **[Text](controls/control-text-box.md)** 속성을 다음 식으로 설정합니다.<br>**Text(Time(Value(Hour.Selected.Value), Value(Minute.Selected.Value), Value(Second.Selected.Value)), DateTimeFormat.LongTime)**
