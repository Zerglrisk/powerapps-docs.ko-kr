...
여러 가지 방법으로 색을 지정할 수 있습니다.

- [**색** ](../functions/function-colors.md) 열거형: 이러한 예제와 같이 cascading style sheet 색 이름을 지정 합니다.

  - **Color.Red**
  - **Color.Indigo**

- [**ColorValue** ](../functions/function-colors.md) 함수: 스타일 시트 및 16 진수 코드 표기법에서 색 이름과 같은 텍스트 문자열 지정 (**#**) 이러한 예제 에서처럼:

  - **ColorValue( "AliceBlue" )**
  - **ColorValue( "#ff00ff" )**

- [**ColorFade** ](../functions/function-colors.md) 함수: 색이를 어떻게 가리키더라도에서 완벽 하 게 black 지정 (-100%) 이 예제와 같이 (100%)을 흰색 완벽 하 게 합니다.

  - **ColorFade( Color.Red, 50% )**

- [**RGBA** ](../functions/function-colors.md) 함수: 0에서 255로 색의 빨강, 녹색 및 파랑 구성 요소를 지정 하 고이 예제와 같이 (완전히 불투명), 100% (완전히 투명) 0%에서 알파 채널을 지정 합니다.

  - **RGBA( 255, 0, 255, 25% )**

색 속성에서 다른 색 속성을 참조할 수도 있습니다. 예를 들어 **Label.PressedColor** 수식을 설정할 수 있습니다 **Label1.Color**, 자동으로 다른 한 속성에서 변경 연계 합니다.
